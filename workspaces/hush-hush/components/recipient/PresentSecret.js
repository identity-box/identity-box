...
const PresentSecret = ({ secret }) => {
  ...
  return (
    <FadingValueBox>
      <Centered>
        <InfoBox marginBottom='20px'><Green>Secret</Green> successfully decrypted:</InfoBox>
        <Textarea id='secret-link' ref={secretField} css={{ height: 'auto' }} readOnly value={secret} />
        <MrSpacer space='30px' />
