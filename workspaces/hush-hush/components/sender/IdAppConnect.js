  ...
  return (
    <FadingValueBox>
      <Centered>
        ...
        <InfoBox marginTop='15px'>1. The DID of the intended recipoient.</InfoBox>
        <InfoBox marginTop='15px'>2. Your current DID - so that the recipient can verify your signature.</InfoBox>
        ...
        <MrSpacer space='20px' />
        <InfoBox>
          Please make sure that you have your <Blue>IdApp</Blue> ready and that you have selected the idenity you want to use before hitting
          <Blue>connect</Blue> below.</InfoBox>
        <MrSpacer space='50px' />
